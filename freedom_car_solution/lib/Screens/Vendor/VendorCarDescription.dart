...
class VendorDescriptionScreen extends StatefulWidget {
  const VendorDescriptionScreen({super.key});

  @override
  State<VendorDescriptionScreen> createState() => _VendorDescriptionScreenState();
}

class _VendorDescriptionScreenState extends State<VendorDescriptionScreen> {
  @override
